...
export default function HelpPage() {
  ...
  const terms: DictionaryTerm[] = [
    ...
    {
      term: 'קצין מנהלה ובטיחות (עוזר המ״פ)',
      abbreviation: 'קמב״צ',
      definition: 'עוזרו הישיר של המ״פ בכל תחום, בדגש על ניהול כוח אדם, טפסולוגיה ועבודות משרד. אחראי על דו״ח 1 פלוגתי ונציג כ״א מול משא״ן גדוד.',
      category: 'פיקוד',
    },
    {
      term: 'חובש פלוגתי',
    ...
    },
    {
      term: 'משק צפנים',
      abbreviation: 'משק״ש',
      definition: 'אחראי על מעקב, אפסון, תיקון וניפוק הצפנים הפלוגתיים וכשירותם. בחירום — קשר המ״פ.',
      category: 'לוגיסטיקה',
    },
    {
      term: 'קשר פלוגתי',
      abbreviation: 'קשפ״ל',
      definition: 'מסייע למשק״ש בתפעול וביצוע משימות התקשוב בפלוגה. בחירום — קשר הסמ״פ.',
      category: 'לוגיסטיקה',
    },
    {
      term: 'משק ארמון (צל״מ)',
      abbreviation: 'מש״ק ארמו״ן',
      definition: 'אחראי על מעקב, אפסון וניפוק הצל״מ הפלוגתי וכשירותו.',
      category: 'לוגיסטיקה',
    },
  ];
